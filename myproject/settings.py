...
# Load SECRET_KEY from environment variable on Render; fallback for local dev
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-esgz*36gjoq2%8+-quh86#%asxaa-y*k52ward425ce2wh=7=a')
